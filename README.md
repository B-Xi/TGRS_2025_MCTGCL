...
<div align=center>Fig. 1: The architecture of the proposed MCTGCL for Mars HSIC. (a) The architecture of the MCTGCL comprises IEAM and LDCT. Specifically, a hybrid loss, including classification loss $L_{cls}$ and supervised graph contrastive loss L_{sgc}, is presented to train the network. (b) The structure of the IEAM. (c) The structure of the LDCT.
